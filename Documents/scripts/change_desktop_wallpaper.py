...
while True:
    random_wallpaper_screen = randint(0,len(images_folder))
    command_to_change_wallpaper = shell_program_command + ' ' + desktop_wallpapers_path + images_folder[random_wallpaper_screen]
